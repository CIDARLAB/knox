...
//		if (outputSpace.hasNodes()) {
//			System.out.println("size: " + outputSpace.getNodes().size());
//		}
...
//    	System.out.println("size: " + outputSpace.getNodes().size());
//    	
//    	System.out.println("cut by " + deletedNodes.size());
...
//    	System.out.println("size: " + designSpaceRepository.getNodes(outputSpaceID).size());
    }

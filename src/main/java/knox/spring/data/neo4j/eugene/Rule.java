...
public class Rule {
    ...
    public Rule(RuleType type) { this.type = type; }
    ...
    public Part getSubject() { return subject; }

    public Part getObject() { return object; }

    public Part getImplicant() {
        if (isBeforeRule()) {
            return object;
        } else if (isAfterRule() || isAdjacencyRule()) {
            return subject;
        } else {
            return null;
        }
    ...
    public int getSubjectIndex() { return subjectIndex; }
    ...
    public boolean isAfterRule() {
        return type.equals(RuleType.AFTER) || type.equals(RuleType.ALL_AFTER) ||
    ...
    public boolean isPrecedenceRule() {
        return isStrictPrecedenceRule() || isNonStrictPrecedenceRule();
    }

    public boolean isStrictPrecedenceRule() {
        return type.equals(RuleType.NEXTTO) ||
            type.equals(RuleType.ALL_NEXTTO) || type.equals(RuleType.BEFORE) ||
            type.equals(RuleType.ALL_BEFORE) || type.equals(RuleType.AFTER) ||

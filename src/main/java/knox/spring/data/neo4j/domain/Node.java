...
public class Node {
	...
	public Edge createEdge(Node head, ArrayList<String> compIDs, ArrayList<String> compRoles, ArrayList<Double> weight) {
        Edge edge = new Edge(this, head, compIDs, compRoles, weight);
